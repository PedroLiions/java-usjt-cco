                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-footer">
                            <form action="ManterPais.do" method="post">
                                ...
                                <button type="submit" class="btn btn-outline-primary" name="acao" value="Excluir">Sim</button>
                            ...
                            <tbody>
          					<c:forEach var="pais" items="${lista }">
                                       <tr>
                                            ...
                                            <td class="actions">
                                                <a class="btn btn-success btn-xs" href="ManterPais.do?acao=Visualizar&id=${pais.id }">Visualizar <i class="fas fa-search"></i></a>
                                                <a class="btn btn-warning btn-xs" href="ManterPais.do?acao=Editar&id=${pais.id }">Editar <i class="fas fa-edit"></i></a>
                                                <button id="btn${pais.id }%>" type="button" class="btn btn-danger btn-xs" data-nome="Pedro 812121" data-toggle="modal" data-target="#delete-modal" data-pais="${pais.id }">Excluir <i class="fas fa-trash-alt"></i></button>
                                            </td>
                                        </tr>
                            </c:forEach>
